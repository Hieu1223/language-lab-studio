...
export default function TranscriptionHistoryPage() {
  ...
  return (
    <div
      ...
      data-testid="transcription-history-page"
    >
      <header className="mb-6 flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Tất cả các bản phiên dịch bạn đã yêu cầu.
          </p>
        </div>
        <Button variant="outline" size="sm" onClick={load} data-testid="reload-history-btn">
          Làm mới
        </Button>
      </header>
