  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm text-center">
        ...
        <p className="text-muted-foreground text-sm mb-8">Đăng nhập để bắt đầu học tiếng Nhật</p>

        <Button onClick={handleLogin} size="lg" className="w-full rounded-xl font-bold text-base gap-2">
